...
* It only displays the "n" last articles and pages recently updated that is not the "n" last written.
...
== Changelog ==
= 1.0.1 =
* correction of errors in English translation (thanks fge from wordpress-fr.net)
